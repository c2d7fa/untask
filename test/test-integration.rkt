  ...
  (test-suite
   ...
   (test-case "Copying item with recur"
     ...
     (check-equal? (capture-output (thunk (execute! (parse "1 copy urgency+$1 from 3000-Feb-4 to 3000-Feb-20 by 5") sb)))
                   ...
                   "  3. Some item  1 0 W:3000-Feb-02 D:3000-Feb-04\n  4. Some item  1 0 W:3000-Feb-07 D:3000-Feb-09\n  5. Some item  1 0 W:3000-Feb-12 D:3000-Feb-14\n  6. Some item  1 0 W:3000-Feb-17 D:3000-Feb-19\n")
     (check-equal? (capture-output (thunk (execute! (parse "2 copy from 3000-Feb-1 to 3000-Feb-2 by 1") sb)))
                   "  7. Another item  0 0 D:3000-Feb-01\n  8. Another item  0 0 D:3000-Feb-02\n"))))
