...
;; modify-expression.
(define ((evaluate-modify-expression modify-expression #:property-types property-types) item-data item)
...
(define (modify-items item-data items modify-expression #:property-types property-types)
  (foldl (λ (item item-data)
           ((evaluate-modify-expression modify-expression #:property-types property-types) item-data item))
         item-data
         (set->list items)))
